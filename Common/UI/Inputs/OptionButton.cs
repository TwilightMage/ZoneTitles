...
//Cone from GroupOptionButton
public class OptionButton<T> : Widget, IGroupOptionButton
{
        ...
        float titleWidthReduction = 10f)
    {
        ...
        uiText.VAlign = 0.5f;
        uiText.Width = StyleDimension.FromPixelsAndPercent(0.0f - titleWidthReduction, 1f);
